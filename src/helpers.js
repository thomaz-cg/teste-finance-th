...
export const RESPONSAVEIS = ['Casal', 'Thomaz', 'Roberta'];
...
// Fixed expenses active this month count as expenses in current month
export function fixedAsExpenses(fixedList) {
  return fixedList
    ...
    .map(f => ({
      ...
      desc: f.desc,
      val: f.val,
      date: currentYM() + '-' + String(f.dueDay).padStart(2, '0'),
      cat: f.cat,
      resp: f.resp,
      obs: 'Gasto fixo',
      isFixed: true,
